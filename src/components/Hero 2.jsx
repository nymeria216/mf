...
import landingImage from "../images/formalme_without_background.png";
    ...
    <>
      <div className="textContainer" style={styles.textContainer}>
        ...
        >
          ...
          <Typewriter
            ...
            onInit={(typewriter) => {
              typewriter.changeDelay(50).typeString("IT-Specialist").start();
            }}
          />
        </motion.div>
      </div>
      ...
      <div className="image-container">
        <motion.img
          ...
          transition={{ delay: 0.25, duration: 0, ease: "easeInOut" }}
